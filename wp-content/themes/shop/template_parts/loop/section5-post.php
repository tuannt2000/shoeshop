<?php 
    ...
    $args_query_indexsection5 = array(
        'post_type' => array('product'),
        'posts_per_page' => 20,
        'orderby' => 'name',
    );

    $query_indexsection5 = new WP_Query( $args_query_indexsection5);

    if ( $query_indexsection5->have_posts() ) {
        while ( $query_indexsection5->have_posts() ) {
            $query_indexsection5->the_post();
            ?>
