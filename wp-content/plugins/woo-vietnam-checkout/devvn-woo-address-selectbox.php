        ...
        function custom_override_checkout_fields($fields)
        {
            ...
            if (!$this->get_options('enable_firstname')) {
                ...
                $fields['billing']['billing_last_name'] = array(
                    'label' => __('Họ và tên', 'devvn-vncheckout'),
                    'placeholder' => _x('Họ tên của bạn', 'placeholder', 'devvn-vncheckout'),
                    'required' => true,
            ...
            if (isset($fields['billing']['billing_phone'])) {
                ...
                $fields['billing']['billing_phone']['label'] = __('Số điện thoại', 'devvn-vncheckout');
                $fields['billing']['billing_phone']['placeholder'] = __('Số điện thoại của bạn', 'devvn-vncheckout');
            }
            if (isset($fields['billing']['billing_email'])) {
                $fields['billing']['billing_email']['class'] = array('form-row-last');
                $fields['billing']['billing_email']['label'] = __('Địa chỉ email(tùy chọn)', 'devvn-vncheckout');
                $fields['billing']['billing_email']['placeholder'] = __('Email của bạn', 'devvn-vncheckout');
            }
            $fields['billing']['billing_state'] = array(
                'label' => __('Tỉnh/Thành phố', 'devvn-vncheckout'),
                'required' => true,
                'type' => 'select',
                'class' => array('form-row-first', 'address-field', 'update_totals_on_change'),
                'placeholder' => _x('Chọn Tỉnh/Thành phố', 'placeholder', 'devvn-vncheckout'),
                'options' => array('' => __('Select Province/City', 'devvn-vncheckout')) + apply_filters('devvn_states_vn', $tinh_thanhpho),
                'priority' => 30
            );
            $fields['billing']['billing_city'] = array(
                'label' => __('Quận/Huyện', 'devvn-vncheckout'),
                'required' => true,
                'type' => 'select',
                'class' => array('form-row-last'),
                'placeholder' => _x('Chọn quận/huyện', 'placeholder', 'devvn-vncheckout'),
                'options' => array(
                    '' => ''
                ),
                'priority' => 40
            ...
            if (!$this->get_options()) {
                $fields['billing']['billing_address_2'] = array(
                    'label' => __('Xã/Phường', 'devvn-vncheckout'),
                    'required' => true,
                    'type' => 'select',
                    'class' => array('form-row-first'),
                    'placeholder' => _x('Chọn xã/phường', 'placeholder', 'devvn-vncheckout'),
                    'options' => array(
                        '' => ''
                    ),
                    'priority' => 50
            ...
            $fields['billing']['billing_address_1']['placeholder'] = _x('Ví dụ: Số 20, ngõ 90', 'placeholder', 'devvn-vncheckout');
            $fields['billing']['billing_address_1']['label'] = _x('Địa chỉ', 'placeholder', 'devvn-vncheckout');
